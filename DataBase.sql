...
INSERT INTO `localidad` VALUES (1,'España','Castilla y Leon','Leon','Leon','24007'),(2,'España','Asturias','Asturias','Gijon','24007'),(3,'España','Madrid','Madrid','Madrid','24007'),(4,'España','Castilla y Leon','Leon','Valencia de don Juan','24007');
...
INSERT INTO `personas` VALUES (1,'71481685P','Mario','Alvarez','Iglesias',NULL,2),(2,'71455269P','Roberto','Diaz','Menedez',NULL,1),(3,'75849658P','Diego','Narciandi','Rodriguez',NULL,1),(4,'76598548P','Sergio','Pérez','Blanco',NULL,2),(5,'72496859P','Adolfo','De la fuente','Herrera',NULL,3),(6,'78596358P','Diego','Martinez','Martinez',NULL,4),(7,'74589685P','Jaime','Herrera','Díaz',NULL,3);
...
INSERT INTO `representantes` VALUES (1,'Pedro','Sanchez','Pérez-Castejón',5,1),(2,'Alberto','Núñez','Feijóo',1,1),(3,'Inés','Arrimadas','García',8,1),(4,'Ione','Belarra','Urteaga',8,1),(5,'José','Guirao','Cabrera',5,2),(6,'Sonia','Ferrer','Tesoro',5,3),(7,'Indalecio','Gutiérrez','Salinas',5,4),(8,'Marina','Bravo','Sobrino',8,2),(9,'Edmundo','Bal','Francés',8,3);
